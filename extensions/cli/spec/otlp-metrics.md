# OTLP Metrics Specification for Continued CLI

This document specifies the OpenTelemetry Protocol (OTLP) metrics that should be emitted by the Continued CLI to provide comprehensive observability and usage monitoring. The metrics are designed to be compatible with Claude Code dashboards for easy migration.

## Overview

The Continued CLI should emit metrics that provide insights into:
...
| `app.version`       | Current Continued CLI version                                 | `OTEL_METRICS_INCLUDE_VERSION` (default: false)     |
...
**Type:** Counter  
**Unit:** `USD`  
**Description:** Cost of the Continued CLI session
...
These metrics are unique to Continued CLI and provide additional insights without conflicting with compatibility:
